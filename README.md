...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-vici-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12084&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-vici-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-vici` can be installed with:

```
conda install yaqd-vici
```

It is possible to list all of the versions of `yaqd-vici` available on your platform with:
